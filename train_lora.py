...
common_voice_16_lang_1 = "yue"
common_voice_16_lang_2 = "zh-HK"
common_voice_17_lang = "yue"
common_voice_17_lang_1 = "zh-HK"
...
common_voice_15 = DatasetDict()
common_voice_15_1 = DatasetDict()
common_voice_16 = DatasetDict()
common_voice_16_1 = DatasetDict()
...
common_voice_15["train"] = load_dataset("mozilla-foundation/common_voice_15_0", common_voice_16_lang_1, split="train+validation", trust_remote_code=True, cache_dir=cache_dir)
common_voice_15["test"] = load_dataset("mozilla-foundation/common_voice_15_0", common_voice_16_lang_1, split="test", trust_remote_code=True, cache_dir=cache_dir)
common_voice_15_1["train"] = load_dataset("mozilla-foundation/common_voice_15_0", common_voice_16_lang_2, split="train+validation", trust_remote_code=True, cache_dir=cache_dir)
common_voice_15_1["test"] = load_dataset("mozilla-foundation/common_voice_15_0", common_voice_16_lang_2, split="test", trust_remote_code=True, cache_dir=cache_dir)
common_voice_16["train"] = load_dataset("mozilla-foundation/common_voice_16_0", common_voice_16_lang_1, split="train+validation", trust_remote_code=True, cache_dir=cache_dir)
common_voice_16["test"] = load_dataset("mozilla-foundation/common_voice_16_0", common_voice_16_lang_1, split="test", trust_remote_code=True, cache_dir=cache_dir)
common_voice_16_1["train"] = load_dataset("mozilla-foundation/common_voice_16_0", common_voice_16_lang_2, split="train+validation", trust_remote_code=True, cache_dir=cache_dir)
common_voice_16_1["test"] = load_dataset("mozilla-foundation/common_voice_16_0", common_voice_16_lang_2, split="test", trust_remote_code=True, cache_dir=cache_dir)
...
common_voice["train"] = concatenate_datasets([common_voice_11["train"], common_voice_11_1["train"], common_voice_17["train"], common_voice_16["train"], common_voice_16_1["train"], common_voice_15["train"], common_voice_15_1["train"]])
common_voice["test"] = concatenate_datasets([common_voice_11["test"], common_voice_11_1["test"], common_voice_17["test"], common_voice_16["test"], common_voice_16_1["test"], common_voice_15["test"], common_voice_15_1["test"]])
